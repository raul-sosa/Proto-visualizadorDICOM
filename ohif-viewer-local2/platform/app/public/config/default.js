  ...
  dataSources: [
...

    {
      ...
      configuration: {
        ...
        name: 'aws',
        wadoUriRoot: 'http://localhost:8042/dicomweb',
        qidoRoot: 'http://localhost:8042/dicomweb',
        wadoRoot: 'http://localhost:8042/dicomweb',
        qidoSupportsIncludeField: false,
    ...
    },
    {
      ...
      configuration: {
        friendlyName: 'AWS S3 Static wado secondary server',
        name: 'aws',
        wadoUriRoot: 'https://localhost:8042/dicomweb',
        qidoRoot: 'https://localhost:8042/dicomweb',
        wadoRoot: 'https://localhost:8042/dicomweb',
        qidoSupportsIncludeField: false,
        supportsReject: false,
        imageRendering: 'wadors',
        thumbnailRendering: 'wadors',
    ...
    },
    {
      ...
      sourceName: 'orthanc',
      configuration: {
        friendlyName: 'Orthanc en red local',
        name: 'Orthanc',
        wadoUriRoot: 'http://localhost:8042/dicom-web', // Cambia esta IP por la de tu Orthanc
